...
const Login = () => {
    const { loginFormData, handleLoginChange, handleLogin } = useLoginPage();
    return (
        <>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    onChange={(e) => handleLoginChange('loginId', e.target.value)}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    required
                                    className="ps-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    onChange={(e) => handleLoginChange('loginPassword', e.target.value)}
                                />
                            </div>
                        </div>
